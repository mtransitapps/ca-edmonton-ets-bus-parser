...
public class EdmontonETSBusAgencyTools extends DefaultAgencyTools {
	...
	private static final String JASPER_PLACE_TC = JASPER_PLACE + " " + TRANSIT_CENTER_SHORT;
	...
	static {
		...
		map2.put(1l, new RouteTripSpec(1l, //
				...
				.addTripSort(MDirectionType.EAST.intValue(), //
						Arrays.asList(new String[] { "5009", "5302", "5110",
						/* + */"1336"/* + */, //
								"1346", "2591", "2301" })) //
		...
		map2.put(9l, new RouteTripSpec(9l, //
				...
				.addTripSort(MDirectionType.NORTH.intValue(), //
						Arrays.asList(new String[] { "4216", "2218", "2875", "1591", "1108",
						/* + */"1476"/* + */, //
								/* + */"7465"/* + */, //
								/* + */"7001"/* + */, //
								"7016",
		...
		map2.put(560l, new RouteTripSpec(560l, //
				...
				MDirectionType.WEST.intValue(), MTrip.HEADSIGN_TYPE_STRING, SPRUCE_GRV) //
				.addTripSort(MDirectionType.EAST.intValue(), //
						Arrays.asList(new String[] { "8730", "8743", "8737", "8785", "8761",
						/* + */"5415"/* + */, //
								"1890", "1983", "1479" })) //
				.addTripSort(MDirectionType.WEST.intValue(), //
						Arrays.asList(new String[] { "1570", "1679", "1860",
						/* + */"5389"/* + */, //
								"8730" })) //
				.compileBothTripSort());
		...
		map2.put(608l, new RouteTripSpec(608l, //
				...
				.addTripSort(MDirectionType.NORTH.intValue(), //
						Arrays.asList(new String[] { /* no stops */})) //
				.addTripSort(MDirectionType.SOUTH.intValue(), //
						Arrays.asList(new String[] { "6593", "6027", "6369", "5211", "5548" })) //
				.compileBothTripSort());
		map2.put(609l, new RouteTripSpec(609l, //
				...
				.addTripSort(MDirectionType.NORTH.intValue(), //
						Arrays.asList(new String[] { /* no stops */})) //
				.addTripSort(MDirectionType.SOUTH.intValue(), //
						Arrays.asList(new String[] { "6593", "6053", "6369", "5211", "5548" })) //
				.compileBothTripSort());
		...
		map2.put(705l, new RouteTripSpec(705l, //
				...
				MDirectionType.WEST.intValue(), MTrip.HEADSIGN_TYPE_STRING, LEWIS_FARMS) //
				.addTripSort(MDirectionType.EAST.intValue(), //
						Arrays.asList(new String[] { "8602", "5001", "5069" })) //
				.addTripSort(MDirectionType.WEST.intValue(), //
						Arrays.asList(new String[] { /* no stops */})) //
				.compileBothTripSort());
		map2.put(706l, new RouteTripSpec(706l, //
				MDirectionType.NORTH.intValue(), MTrip.HEADSIGN_TYPE_STRING, JASPER_PLACE_TC, // _157_ST_100A_AVE
		...
		map2.put(708l, new RouteTripSpec(708l, //
				MDirectionType.NORTH.intValue(), MTrip.HEADSIGN_TYPE_STRING, JASPER_PLACE_TC, //
				MDirectionType.SOUTH.intValue(), MTrip.HEADSIGN_TYPE_STRING, WEST_EDM_MALL) //
				.addTripSort(MDirectionType.NORTH.intValue(), //
		...
		map2.put(802l, new RouteTripSpec(802l, //
				...
				MDirectionType.SOUTH.intValue(), MTrip.HEADSIGN_TYPE_STRING, JASPER_PLACE_TC) //
				.addTripSort(MDirectionType.NORTH.intValue(), //
		...
		map2.put(806l, new RouteTripSpec(806l, //
				...
				.addTripSort(MDirectionType.NORTH.intValue(), //
						Arrays.asList(new String[] { "5181", "5107", "5207", "6333", "7011" })) //
				.addTripSort(MDirectionType.SOUTH.intValue(), //
						Arrays.asList(new String[] { /* no stops */})) //
				.compileBothTripSort());
		...
		map2.put(835l, new RouteTripSpec(835l, //
				...
				.addTripSort(MDirectionType.NORTH.intValue(), //
						Arrays.asList(new String[] { "1979", "6333", "6579", "7003" })) //
				.addTripSort(MDirectionType.SOUTH.intValue(), //
						Arrays.asList(new String[] { /* no stops */})) //
				.compileBothTripSort());
		map2.put(836l, new RouteTripSpec(836l, //
				...
				.addTripSort(MDirectionType.NORTH.intValue(), //
						Arrays.asList(new String[] { "1109", "1669", "6328", "6252", "7003" })) //
				.addTripSort(MDirectionType.SOUTH.intValue(), //
						Arrays.asList(new String[] { /* no stops */})) //
				.compileBothTripSort());
		...
		map2.put(840l, new RouteTripSpec(840l, //
				...
				.addTripSort(MDirectionType.NORTH.intValue(), //
						Arrays.asList(new String[] { "5206", "6333", "6002", "6047", "6001" })) //
				.addTripSort(MDirectionType.SOUTH.intValue(), //
						Arrays.asList(new String[] { /* no stops */})) //
				.compileBothTripSort());
		...
		map2.put(844l, new RouteTripSpec(844l, //
				...
				.addTripSort(MDirectionType.EAST.intValue(), //
						Arrays.asList(new String[] { "7358", "7286", "7206", "7104", "7470", "7437" })) //
				.addTripSort(MDirectionType.WEST.intValue(), //
						Arrays.asList(new String[] { "7437", "7470", "7105" })) //
				.compileBothTripSort());
		...
		map2.put(859l, new RouteTripSpec(859l, //
				...
				MDirectionType.SOUTH.intValue(), MTrip.HEADSIGN_TYPE_STRING, ARCH_MAC) //
				.addTripSort(MDirectionType.NORTH.intValue(), //
						Arrays.asList(new String[] { "5548", "5207", "6333", "7011" })) //
				.addTripSort(MDirectionType.SOUTH.intValue(), //
						Arrays.asList(new String[] { /* no stops */})) //
				.compileBothTripSort());
		...
		map2.put(916l, new RouteTripSpec(916l, //
				...
				MDirectionType.SOUTH.intValue(), MTrip.HEADSIGN_TYPE_STRING, WESTMOUNT) //
				.addTripSort(MDirectionType.NORTH.intValue(), //
						Arrays.asList(new String[] { "5206", "6002" })) //
				.addTripSort(MDirectionType.SOUTH.intValue(), //
						Arrays.asList(new String[] { /* no stops */})) //
				.compileBothTripSort());
		...
		map2.put(941l, new RouteTripSpec(941l, //
				...
				MDirectionType.SOUTH.intValue(), MTrip.HEADSIGN_TYPE_STRING, AOB) //
				.addTripSort(MDirectionType.NORTH.intValue(), //
						Arrays.asList(new String[] { "2915", "1003" })) //
				.addTripSort(MDirectionType.SOUTH.intValue(), //
						Arrays.asList(new String[] { /* no stops */})) //
				.compileBothTripSort());
		...
		map2.put(952l, new RouteTripSpec(952l, //
				...
				MDirectionType.WEST.intValue(), MTrip.HEADSIGN_TYPE_STRING, ST_FRANCIS_XAVIER) //
				.addTripSort(MDirectionType.EAST.intValue(), //
						Arrays.asList(new String[] { "5071", "5174", "5433", "5120" })) //
				.addTripSort(MDirectionType.WEST.intValue(), //
						Arrays.asList(new String[] { /* no stops */})) //
				.compileBothTripSort());
		...
		map2.put(970l, new RouteTripSpec(970l, //
				...
				.addTripSort(MDirectionType.NORTH.intValue(), //
						Arrays.asList(new String[] { "4950", "4636", "4811", "4597", "4153" })) //
				.addTripSort(MDirectionType.SOUTH.intValue(), //
						Arrays.asList(new String[] {/* no stops */})) //
				.compileBothTripSort());
